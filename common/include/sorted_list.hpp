...
/** This class is a light alternative to std::set.
    ...
    The sorted list achieves the same O(log(N)) look up com-
    ...
    container
        ...
        using lst_t = sorted_list<test, comp>;
        lst_t ls;
        // ... fill ls with some data ...
        // Then find the element that has the 'id' equal to 5
        lst_t::iterator it = ls.find(5);

    There is also a specialization of the sorted_list for
    reference types, which is something std::list cannot do.
...
public :
    using iterator = ptr_iterator_base<base_iterator, sorted_list_t>;
    using const_iterator = const_ptr_iterator_base<base_const_iterator, sorted_list_t>;
    using reverse_iterator = reverse_ptr_iterator_base<base_reverse_iterator, sorted_list_t>;
    using const_reverse_iterator = const_reverse_ptr_iterator_base<base_const_reverse_iterator, sorted_list_t>;
