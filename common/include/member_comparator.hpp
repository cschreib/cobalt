...
#define mem_fun_comp(f) ctl::mem_fun_comp_< \
    typename ctl::mem_fun_traits<decltype(f)>::owner, \
    typename ctl::mem_fun_traits<decltype(f)>::return_type, \
    f \
>

#define mem_var_comp(v) ctl::mem_var_comp_< \
    typename ctl::mem_var_traits<decltype(v)>::owner, \
    typename ctl::mem_var_traits<decltype(v)>::type, \
    v \
>
