...
class work_loop {
    ...
    ctl::lock_free_queue<std::string> ac_queries_;
    sol::state lua_;
    ...
    void autocomplete_(const std::string& cmd);
...
public :
    ...
    void autocompletion_query(std::string cmd);
    ctl::lock_free_queue<std::vector<std::string>> autocompletion_results;
